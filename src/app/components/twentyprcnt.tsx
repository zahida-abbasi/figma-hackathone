...
const Twentyprcnt = () => {
  return (
    <>
    <div>
      <h1 className="text-3xl font-bold text-blue-900 mb-4 justify-center text-center">Discount Item</h1>
      <div className="flex justify-center items-center space-x-6 text-lg font-medium">
        {/* Active Category */}
        <Link
          href="#"
          className="text-pink-500 underline decoration-pink-500 decoration-2 underline-offset-4"
        >
          Wood Chair
        </Link>
        <span className="text-blue-900">•</span>
        {/* Inactive Categories */}
        <Link href="#" className="text-blue-900 hover:text-pink-500 transition">
          Plastic Chair
        </Link>
        <Link href="#" className="text-blue-900 hover:text-pink-500 transition">
          Sofa Collection
    ...
    <div className='mt-20'>
    <div className="flex gap-5 max-md:flex-col mb-40">
