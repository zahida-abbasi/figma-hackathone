...
const Baner = () => {
  return (
    ...
    <div className="flex relative flex-col items-center px-20 pt-44 pb-24 w-full min-h-[462px] max-md:px-5 max-md:py-24 max-md:max-w-full">
      ...
      <div className="flex relative flex-col mb-0 max-w-full w-[574px] max-md:mb-2.5">
        ...
        <div className="self-center px-8 text-center py-4 mt-7 max-w-full text-lg tracking-wide text-white bg-pink-500 rounded-sm w-[173px] max-md:px-5">
          Shop Now
        </div>
      </div>
    </div>
  ...
  className="object-contain w-full aspect-[9.71] max-w-[904px]"
/>
